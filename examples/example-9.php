...
<html>
  ...
  <body>
    ...
    <script type="text/javascript" src="js/heatcanvas/heatcanvas.js"></script>
    <script type="text/javascript" src="js/heatcanvas/heatcanvas-leaflet.js"></script>
    <script>
				...
				if(trequest!=request){
					...
					$.getJSON(request, function( data ) {
						...
						for(var i=0,l=data.data.length; i<l; i++) {
							heatmap.pushData(data.data[i][0], data.data[i][1], data.data[i][2]);
						}

						heatmap.setMax(data.max);
						layer.clearLayers();
